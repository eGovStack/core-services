...
import org.egov.wf.util.BusinessUtilV2;
...
@Component
public class WorkflowValidatorV2 {


    private WorkflowUtilV2 util;

    private BusinessUtilV2 businessUtil;


    @Autowired
    public WorkflowValidatorV2(WorkflowUtilV2 util, BusinessUtilV2 businessUtil) {
        this.util = util;
