...
public class BusinessServiceController {
	...
	public BusinessServiceController(BusinessMasterService businessMasterService,
			BusinessMasterServiceV2 businessMasterServiceV2, ResponseInfoFactory responseInfoFactory,
	...
	public ResponseEntity<BusinessServiceResponse> search(@Valid @RequestParam Map<String, String> criteria,
		...
		BusinessServiceSearchCriteria searchCriteria = mapper.convertValue(criteria,
				BusinessServiceSearchCriteria.class);
		...
		if (searchCriteria != null && searchCriteria.getBusinessServices() != null && businessServicesParms!="" && workflowUtilV2.isV2Service(businessServicesParms)) {
			...
			BusinessServiceSearchCriteriaV2 searchCriteriaV2 = mapper.convertValue(criteria,
					BusinessServiceSearchCriteriaV2.class);
			...
			response = BusinessServiceResponse.builder().businessServices(businessServices).responseInfo(
