...
@Slf4j
@Service
public class TransitionServiceV2 {


    private WorKflowRepositoryV2 repository;
    ...
    @Autowired
    public TransitionServiceV2(WorKflowRepositoryV2 repository,
                             BusinessServiceRepositoryV2 businessServiceRepository,
    ...
    private Map<String,ProcessInstance> prepareProcessStateAndAction(List<ProcessInstance> processInstances,BusinessService businessService) {
         ...
         */
        ProcessInstanceSearchCriteriaV2 criteria = new ProcessInstanceSearchCriteriaV2();
