...
public class WorkflowUtilV2 {
    ...
    @Autowired
    public WorkflowUtilV2(ObjectMapper mapper, WorkflowConfig config, BusinessServiceRepositoryV2 businessServiceRepository) {
        this.mapper = mapper;
        this.config = config;
...
/*    public List<String> getActionableStatusesForRole(RequestInfo requestInfo, List<BusinessService> businessServices,ProcessInstanceSearchCriteria criteria){
     ...
     * @return
     */
    public void enrichStatusesInSearchCriteria(RequestInfo requestInfo, ProcessInstanceSearchCriteriaV2 criteria){
