...
public class WorkflowQueryBuilderV2 {
    ...
    public String getProcessInstanceIds(ProcessInstanceSearchCriteriaV2 criteria, List<Object> preparedStmtList){
     ...
     * @return Query with pagination
     */
    private void addPagination(StringBuilder query,List<Object> preparedStmtList,ProcessInstanceSearchCriteriaV2 criteria){
        int limit = config.getDefaultLimit();
        int offset = config.getDefaultOffset();
        query.append(" OFFSET ? ");
        query.append(" LIMIT ? ");
     ...
     * @return
     */
    public String getInboxCount(ProcessInstanceSearchCriteriaV2 criteria, List<Object> preparedStmtList,Boolean statuCount){
    ...
    public String getProcessInstanceCount(ProcessInstanceSearchCriteriaV2 criteria, List<Object> preparedStmtList, boolean statuCount) {
    ...
    public String getInboxApplicationsBusinessIdsQuery(ProcessInstanceSearchCriteriaV2 criteria, ArrayList<Object> preparedStmtList) {
