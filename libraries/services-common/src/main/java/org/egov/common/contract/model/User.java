...
import org.egov.common.contract.exceptions.*;
import org.egov.common.contract.model.enums.*;
import org.egov.common.utils.*;

import java.util.*;

import static org.egov.common.utils.Utils.isEmpty;
...
public class User {
    ...
    public boolean isRolesAbsent() {
        return isEmpty(roles) || roles.stream().anyMatch(r -> isEmpty(r.getCode()));
    }
