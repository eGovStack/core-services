...
// Taken from Spring Boot Http Status
...
public enum HttpStatus {
     ...
     * {@link org.egov.common.contract.model.HttpStatus.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.egov.common.contract.model.HttpStatus.Series#SUCCESSFUL}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.egov.common.contract.model.HttpStatus.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.egov.common.contract.model.HttpStatus.Series#CLIENT_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link org.egov.common.contract.model.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 4.0
     * @see #series()
     */
