...
To setup the workflow service in your local system, clone the [Core Service repository](https://github.com/egovernments/core-services).
...
To run the workflow services locally, you need to port forward below services locally
