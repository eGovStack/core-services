...
const envVariables = {
    ...
    covaApiConfigs: {
        covaProdUrl                : 'https://covaprod.punjab.gov.in/api/cova/citizen/services/v1/',
        isHomeIsolatedSuffix       : 'status/isHomeIsolated',
        updateSelfInspectionSuffix : 'status/updateSelfInspection',
        insertPatientInfoUrl          : 'https://cova.punjab.gov.in/api/cova/citizen/services/v1/insert-whats-app-pm-data',
