...
const envVariables = {
  ...
  covaApiConfigs: {
    ...
    covaUrlHospital: 'https://cova.punjab.gov.in/api/cova/hospital/services/v1/',
    ...
    covidApiSuffix: 'https://www.api.pbcovidhelpline.com/',
    covidApiRmoAuth: 'isRMO/',
    ...
    getGISByMobileNumber:'https://pmidcprojects.punjab.gov.in/API/jalandhar/mobile', 
    getPropertyByPropertId:'https://pmidcprojects.punjab.gov.in/API/jalandhar/search',
    addedNewProperty:'https://pmidcprojects.punjab.gov.in/API/jalandhar/addJalandhar',
    updateNewProperty:'https://pmidcprojects.punjab.gov.in/API/jalandhar/updateJalandhar',
    getMVByMobileNumber:'https://pmidcprojects.punjab.gov.in/API/chatbox',
    getMVLogin:'/login',
    submitPostEndReport:'/postEndReport',
    submitPostStartReport:'/postStartReport',
    submitPostIntermediateReport:'/postIntermediateReport',
