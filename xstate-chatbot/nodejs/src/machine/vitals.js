      ...
      states: {
        temperature: {
          ...
          states: {
            prompt: {
              onEntry: assign((context, event) => {
                dialog.sendMessage(context, dialog.get_message(messages.registerVitals.temperature.prompt, context.user.locale));
              }),
              on: {
            ...
            error: {
              onEntry: assign((context, event) => {
                dialog.sendMessage(context, dialog.get_message(messages.registerVitals.temperature.error, context.user.locale), false);
              }),
              always: 'prompt'
            }
          }
        ...
        pulse: {
          ...
          states: {
            prompt: {
              onEntry: assign((context, event) => {
                dialog.sendMessage(context, dialog.get_message(messages.registerVitals.pulse.prompt, context.user.locale));
              }),
              on: {
                USER_MESSAGE: 'process'
              }
          ...
          states: {
            prompt: {
              onEntry: assign((context, event) => {
                ...
                dialog.sendMessage(context, dialog.get_message(messages.registerVitals.spo2.prompt, context.user.locale));
              }),
              on: {
                USER_MESSAGE: 'process'
              }
              ...
              states: {
                prompt: {
                  onEntry: assign((context, event) => {
                    ...
                    let message = dialog.get_message(messages.registerVitals.symptoms.lossOfSmellTaste.prompt, context.user.locale);
            ...
            fluLikeSymptoms: {
              ...
              states: {
                prompt: {
                  onEntry: assign((context, event) => {
                    context.grammer = grammers.binaryChoice.grammer;
                    let message = dialog.get_message(messages.registerVitals.symptoms.fluLikeSymptoms.prompt, context.user.locale);
                    message += dialog.get_message(grammers.binaryChoice.prompt, context.user.locale);
                    dialog.sendMessage(context, message);
                  }),
                  on: {
            ...
            respiratoryIssues: {
              ...
              states: {
                prompt: {
                  onEntry: assign((context, event) => {
                    context.grammer = grammers.binaryChoice.grammer;
                    let message = dialog.get_message(messages.registerVitals.symptoms.respiratoryIssues.prompt, context.user.locale);
                    message += dialog.get_message(grammers.binaryChoice.prompt, context.user.locale);
                    dialog.sendMessage(context, message);
                  }),
                  on: {
            ...
            comorbidities: {
              ...
              states: {
                prompt: {
                  onEntry: assign((context, event) => {
                    context.grammer = grammers.binaryChoice.grammer;
                    let message = dialog.get_message(messages.registerVitals.symptoms.comorbidities.prompt, context.user.locale);
                    message += dialog.get_message(grammers.binaryChoice.prompt, context.user.locale);
                    dialog.sendMessage(context, message);
                  }),
                  on: {
        ...
        addVitals: {
          ...
          invoke: {
            ...
            onDone: {
              actions: assign((context, event) => {
                dialog.sendMessage(context, dialog.get_message(messages.registerVitals.addVitals, context.user.locale));
              }),
              target: '#endstate'
            }
          }
