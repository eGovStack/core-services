...
let messages = {
  ...
  openSearch: {
    ...
    pa_IN: "ਆਪਣਾ ਪ੍ਰਾਪਰਟੀ ਟੈਕਸ search ਦੀ ਭਾਲ ਕਰਨ ਅਤੇ ਅਦਾਇਗੀ ਕਰਨ ਲਈ ਹੇਠਾਂ ਦਿੱਤੇ ਲਿੰਕ ਤੇ ਕਲਿੱਕ ਕਰੋ 👇\n\n{{link}}\n\nनीचे दी गई छवि आपको दिखाती है कि इस लिंक का उपयोग करके {{billserviceName}} की खोज और भुगतान कैसे करें।"
  },
  ...
  paymentDisclaimer: {
    ...
    pa_IN: '👉 ਇਸ ਲਿੰਕ ਤੇ ਕਲਿਕ ਕਰਕੇ ਤੁਸੀਂ ਪੁਸ਼ਟੀ ਕਰਦੇ ਹੋ ਕਿ ਤੁਹਾਡਾ ਗਿਣਿਆ ਹੋਇਆ ਪ੍ਰਾਪਰਟੀ ਟੈਕਸ ਸਹੀ ਹੈ'
  }
}
let grammer = {
  confirmation: {
